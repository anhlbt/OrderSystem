<template>
  <div id="guide">
    <van-nav-bar title="A la carte treasure" fixed left-arrow @click-left="$router.push('/')" />
    <section>
    ...
    <van-popup v-model="orderView" position="bottom" :style="{ height: '70%' }">
      <div class="popup">
        <div class="popup-bd">
          ...
          <div class="order">
            <div class="hd">
              <van-divider>{{orderData.seat_name}}information</van-divider>
            ...
            <div class="bd">
              ...
              <div class="goods">
                <div class="item" v-for="(e,i) in orderData.dishes" :key="i">
                  ...
                  <div class="ft">
                    <span>{{e.order_dishes.dishes_num}}/share</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="popup-ft">
          <button class="van-button--primary" @click="handle(1,orderData)">Scan code to pay</button>
          <button class="van-button--warning" @click="handle(2,orderData)">Increase or decrease dishesease or decrease dishes</button>
          <button class="van-button--info" @click="handle(3,orderData)">Cancel order</button>
        </div>
      </div>
